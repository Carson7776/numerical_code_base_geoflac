...
class Plot:
    ...
    def plot_aps_distance(self, frame):
        ...
        fig_highest.savefig(f"aps_dist_to_highest_frame_{frame}.png", pad_inches=0.1, bbox_inches='tight', dpi=1200)
        ...
        fig_lowest.savefig(f"aps_dist_to_lowest_frame_{frame}.png", pad_inches=0.1, bbox_inches='tight', dpi=1200)
